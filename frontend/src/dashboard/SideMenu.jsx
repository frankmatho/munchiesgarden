...
import { HiArrowSmRight, HiChartPie, HiInbox, HiOutlineCloudUpload, HiSupport, HiTable, HiUser, HiViewBoards } from "react-icons/hi";
  ...
  return (
    ...
    <Sidebar.Items>
      ...
      <Sidebar.ItemGroup>
        ...
        <Sidebar.Item href="/admin/dashboard/orders" icon={MdFastfood} className='mt-3  hover:bg-gray-200'>
